"""Shared migration test fixtures (make_plan factory)."""
...
def make_plan() -> Callable[..., MigrationPlanV1]:
    """Fixture returning the :func:`_make_plan` factory (reusable across files)."""
